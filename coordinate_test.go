...
func (s *stubCoordinator) claimRuns(context.Context, []fsmKey, resumeCheck) ([]claimedRun, error) {
	return nil, nil
}
...
func (w *wakeCoordinator) claimRuns(context.Context, []fsmKey, resumeCheck) ([]claimedRun, error) {
	w.claimCount.Add(1)
	return nil, nil
}
