...
// it, if any. Its context carries the values initializers put on the transitions' context but
...
// backend a run this node failed to resume before is skipped while its backoff lasts, and
