...
const (
	...
	HaltKind_HALT_KIND_UNSPECIFIED          HaltKind = 0
	HaltKind_HALT_KIND_CANCELED             HaltKind = 1
	HaltKind_HALT_KIND_ABORT                HaltKind = 2
	HaltKind_HALT_KIND_UNRECOVERABLE_SYSTEM HaltKind = 3
	HaltKind_HALT_KIND_UNRECOVERABLE_USER   HaltKind = 4
	HaltKind_HALT_KIND_HANDOFF              HaltKind = 5
	// HALT_KIND_ERROR is a halt whose error is none of the types above.
	HaltKind_HALT_KIND_ERROR HaltKind = 6
)

// Enum value maps for HaltKind.
var (
	HaltKind_name = map[int32]string{
		0: "HALT_KIND_UNSPECIFIED",
		1: "HALT_KIND_CANCELED",
		2: "HALT_KIND_ABORT",
		3: "HALT_KIND_UNRECOVERABLE_SYSTEM",
		4: "HALT_KIND_UNRECOVERABLE_USER",
		5: "HALT_KIND_HANDOFF",
		6: "HALT_KIND_ERROR",
	}
	HaltKind_value = map[string]int32{
...
func (x HaltKind) Enum() *HaltKind {
	p := new(HaltKind)
	*p = x
	return p
}

func (x HaltKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HaltKind) Descriptor() protoreflect.EnumDescriptor {
	return file_fsm_v1_event_proto_enumTypes[0].Descriptor()
}

func (HaltKind) Type() protoreflect.EnumType {
	return &file_fsm_v1_event_proto_enumTypes[0]
}

func (x HaltKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HaltKind.Descriptor instead.
func (HaltKind) EnumDescriptor() ([]byte, []int) {
...
func (RunEventKind) Descriptor() protoreflect.EnumDescriptor {
	return file_fsm_v1_event_proto_enumTypes[2].Descriptor()
}

func (RunEventKind) Type() protoreflect.EnumType {
	return &file_fsm_v1_event_proto_enumTypes[2]
}
...
type StateEvent struct {
	...
	HaltKind HaltKind `protobuf:"varint,10,opt,name=halt_kind,json=haltKind,proto3,enum=fsm.v1.HaltKind" json:"halt_kind,omitempty"`
	...
	// iterations_completed is, on the COMPLETE of an iteration of a repeated transition
	// (RepeatWhile), how many of its iterations have completed: that iteration's index plus one.
	// Zero on every other event, including the COMPLETE a repeated transition records when its
	// predicate answers RepeatDone, which marks the transition finished.
	IterationsCompleted uint32 `protobuf:"varint,12,opt,name=iterations_completed,json=iterationsCompleted,proto3" json:"iterations_completed,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *StateEvent) GetHaltKind() HaltKind {
	if x != nil {
		return x.HaltKind
	}
...
func (x *StateEvent) GetErrorState() string {
	if x != nil {
		return x.ErrorState
	}
	return ""
...
func (x *StateEvent) GetIterationsCompleted() uint32 {
	if x != nil {
...
var file_fsm_v1_event_proto_rawDesc = string([]byte{
	...
	0x8d, 0x03, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x25,
	...
	,
	...
	0x63, 0x65, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x07,
	...
	,
	...
	,
})
...
var file_fsm_v1_event_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_fsm_v1_event_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_fsm_v1_event_proto_goTypes = []any{
	(HaltKind)(0),        // 0: fsm.v1.HaltKind
	(EventType)(0),       // 1: fsm.v1.EventType
	(RunEventKind)(0),    // 2: fsm.v1.RunEventKind
	(*ActiveEvent)(nil),  // 3: fsm.v1.ActiveEvent
	(*EventOptions)(nil), // 4: fsm.v1.EventOptions
	(*StateEvent)(nil),   // 5: fsm.v1.StateEvent
	(*HistoryEvent)(nil), // 6: fsm.v1.HistoryEvent
	(*RunEvent)(nil),     // 7: fsm.v1.RunEvent
	nil,                  // 8: fsm.v1.ActiveEvent.TraceContextEntry
}
var file_fsm_v1_event_proto_depIdxs = []int32{
	4, // 0: fsm.v1.ActiveEvent.options:type_name -> fsm.v1.EventOptions
	8, // 1: fsm.v1.ActiveEvent.trace_context:type_name -> fsm.v1.ActiveEvent.TraceContextEntry
	1, // 2: fsm.v1.StateEvent.type:type_name -> fsm.v1.EventType
	0, // 3: fsm.v1.StateEvent.halt_kind:type_name -> fsm.v1.HaltKind
	3, // 4: fsm.v1.HistoryEvent.active_event:type_name -> fsm.v1.ActiveEvent
	5, // 5: fsm.v1.HistoryEvent.last_event:type_name -> fsm.v1.StateEvent
	2, // 6: fsm.v1.RunEvent.kind:type_name -> fsm.v1.RunEventKind
	1, // 7: fsm.v1.RunEvent.type:type_name -> fsm.v1.EventType
