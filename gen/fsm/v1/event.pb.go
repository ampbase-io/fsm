...
type StateEvent struct {
	...
	// error_kind classifies a halted run's error so the typed error is rebuilt the same on every
	// node: canceled, abort, unrecoverable_system, unrecoverable_user, handoff, or error. Empty
	// on success, and on records written before it was recorded.
...
func (x *StateEvent) GetErrorKind() string {
	if x != nil {
		return x.ErrorKind
	}
	return ""
...
var file_fsm_v1_event_proto_rawDesc = string([]byte{
	...
	0xca, 0x02, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x25,
	...
	0x52, 0x0a, 0x72, 0x75, 0x6e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x65,
	...
	0x10, 0x04, 0x42, 0x7d, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x73, 0x6d, 0x2e, 0x76, 0x31,
	0x42, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2a,
